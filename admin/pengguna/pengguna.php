                                    ...
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?=$row['jabatan']  ?></td>
                                                            <td>
                                                                <a  onclick="return confirm('Yakin Hapus <?= $row["username"]; ?>')" href="hapus.php?id=<?php echo $row['id_admin']; ?>" class="btn btn-danger">Hapus</a>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
                                                ...
                                                <a href="pengguna/pengguna/tambah.php" class="btn btn-primary">Tambah Data</a>
                                                 </div>
                        </div>
    </section>
