<?php
    ...
    */
    ...
    $npm = $_GET['npm'];
    $sql = $conn->query("SELECT * FROM peserta WHERE npm ='$npm'");
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="body">
                                           <form method="POST" enctype="multipart/form-data" >
                                                ...
                                                <div class="form-group">
                                                     <div class="form-line">
                                                         <input type="number" class="form-control" value="<?=$tampil['nilai']; ?>" name="nilai"/>
                                                            </div>
                                                        </div>
...
if (isset($_POST['simpan'])) {
    ...
    $sql = $conn->query("UPDATE peserta SET  npm = '$npm',  nama = '$nama', kelas = '$kelas', alamat = '$alamat', nilai = '$nilai' WHERE npm = '$npm'");  
