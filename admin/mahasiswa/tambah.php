...
if (isset($_POST['simpan'])) {
    ...
    $sql = $conn->query("INSERT INTO peserta VALUES('$npm','$nama','$kelas','$alamat','$nilai')");

    if($sql){
        ?>
        <script type="text/javascript">alert('DAta Berhasil Disimpan'); window.location.href="../../admin/mahasiswa/mahasiswa.php";</script>
        <?php 
